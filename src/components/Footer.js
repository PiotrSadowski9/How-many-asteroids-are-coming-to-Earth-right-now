    ...
    render() {
        return (
            <footer className={'footerBox'}>
                ...
                <p className={'footerText'}>Asteroids, sometimes called minor planets, are rocky, airless 
                ...
                within the main asteroid belt. Asteroids range in size from Vesta — the largest at about 329
                 ...
                 <p className={'footerMoreInfo'}>You can find more informations on <a 
                 href='https://solarsystem.nasa.gov/asteroids-comets-and-meteors/asteroids/in-depth/#many_shapes_and_sizes_otp'>
                     NASA
                 </a> website.</p>
                 <p className={'footerMoreInfo expand'}>You can also check tomarrows asteroid by clicking <button id={'buttonNextDay'} onClick={this.props.handleClick}>HERE</button></p>
            </footer>
        )
    }
}
